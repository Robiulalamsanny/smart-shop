		...
		<div class="sap_tabs">
			<div id="horizontalTab" style="display: block; width: 100%; margin: 0px;">
				<ul class="resp-tabs-list">
					...
					<li class="resp-tab-item" aria-controls="tab_item-1" role="tab"><span>Men's Collections</span></li> 
					<li class="resp-tab-item" aria-controls="tab_item-2" role="tab"><span>Women's Collections</span></li> 
				</ul>				  	 
				<div class="resp-tabs-container">
					<div class="tab-1 resp-tab-content" aria-labelledby="tab_item-0">
						@foreach($publishedProduct as $publishedProduct)
						<div class="col-md-3 product-men">
							<div class="men-pro-item simpleCart_shelfItem">
								<div class="men-thumb-item">
									<img src="{{ asset($publishedProduct->product_image ) }}" alt="" class="pro-image-front" height="300" width="300">
									<img src="{{ asset($publishedProduct->product_image ) }}" alt="" class="pro-image-back" height="300" width="300">
								...
								<div class="item-info-product ">
									<h4><a href="{{ url('/product-details/'.$publishedProduct->id) }}">{{ $publishedProduct->product_name }}</a></h4>
									<div class="info-product-price">
										<span class="item_price">BDT {{ $publishedProduct->product_price }}</span>
					...
					<div class="tab-1 resp-tab-content" aria-labelledby="tab_item-1">
						@foreach($mensOffer as $mensOffer)
						<div class="col-md-3 product-men">
							<div class="men-pro-item simpleCart_shelfItem">
								<div class="men-thumb-item">
									<img src="{{ asset($mensOffer->product_image ) }}" alt="" class="pro-image-front" height="300" width="300">
									<img src="{{ asset($mensOffer->product_image ) }}" alt="" class="pro-image-back" height="300" width="300">
										<div class="men-cart-pro">
											<div class="inner-men-cart-pro">
												<a href="{{ url('/product-details/'.$mensOffer->id) }}" class="link-product-add-cart">Quick View</a>
											</div>
										</div>
										<span class="product-new-top">New</span>
								...
								<div class="item-info-product ">
									<h4><a href="{{ url('/product-details/'.$mensOffer->id) }}">{{ $mensOffer->product_name }}</a></h4>
									<div class="info-product-price">
										<span class="item_price">BDT {{ $mensOffer->product_price }}</span>
					...
					<div class="tab-1 resp-tab-content" aria-labelledby="tab_item-2">
						@foreach($womenOffer as $womenOffer)
						<div class="col-md-3 product-men">
							<div class="men-pro-item simpleCart_shelfItem">
								<div class="men-thumb-item">
									<img src="{{ asset($womenOffer->product_image ) }}" alt="" class="pro-image-front" height="300" width="300">
									<img src="{{ asset($womenOffer->product_image ) }}" alt="" class="pro-image-back" height="300" width="300">
										<div class="men-cart-pro">
											<div class="inner-men-cart-pro">
												<a href="{{ url('/product-details/'.$womenOffer->id) }}" class="link-product-add-cart">Quick View</a>
											</div>
										</div>
										<span class="product-new-top">New</span>
								...
								<div class="item-info-product ">
									<h4><a href="{{ url('/product-details/'.$womenOffer->id) }}">{{ $womenOffer->product_name }}</a></h4>
									<div class="info-product-price">
										<span class="item_price">BDT {{ $womenOffer->product_price }}</span>
